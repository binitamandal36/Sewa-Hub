    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href=""><span class="fas fa-credit-card"></span>
                    <span>Payment Management</span></a>
                </li>

                <li>
                    <a href=""><span class="fas fa-chart-line"></span>
                    <span>Reports and Analytics</span></a>
                </li>

                <li>
                    <a href=""><span class="fas fa-bell"></span>
                    <span>Notifications and Announcements</span></a>
                </li>

                <li>
                    <a href=""><span class="fas fa-comments"></span>
